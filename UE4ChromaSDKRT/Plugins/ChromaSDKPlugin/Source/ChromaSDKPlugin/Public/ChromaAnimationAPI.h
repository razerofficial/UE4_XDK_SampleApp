...
*/
typedef RZRESULT	(*PLUGIN_CREATE_EFFECT)(RZDEVICEID deviceId, ChromaSDK::EFFECT_TYPE effect, int* colors, int size, FChromaSDKGuid* effectId);
/*
	Delete an effect given the effect id.
*/
typedef RZRESULT	(*PLUGIN_DELETE_EFFECT)(const FChromaSDKGuid& effectId);
/*
...
*/
typedef RZRESULT	(*PLUGIN_SET_EFFECT)(const FChromaSDKGuid& effectId);
/*
